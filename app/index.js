...
module.exports = generators.Base.extend({
    constructor: function() {
        ...
        if (this.options["test-framework"] === "mocha") {
            testLocal = require.resolve(
                "generator-mocha/generators/app/index.js"
            );
        } else if (this.options["test-framework"] === "jasmine") {
            testLocal = require.resolve(
                "generator-jasmine/generators/app/index.js"
            );
        }

        this.composeWith(
            this.options["test-framework"] + ":app",
            {
                options: {
        ...
        var prompts = [
            {
                ...
                message:
                    ...
                    chalk.green.bold("Green means go!") +
                    ")",
                choices: [
                    {
                        name: "Modernizr",
    ...
    writing: {
        ...
        linters: function() {
            this.fs.copy(
                ...
                this.destinationPath(".sasslintrc")
            );
